...
class Ventana3(QMainWindow):
    ...
    def __init__(self, anterior):
        ...
        self.imagenFondo = QPixmap("imagenes/img_12.png")
        ...
        #---add-----
        self.add = QAction(QIcon('imagenes/img_9.png'), 'Add', self)
        self.add.triggered.connect(self.accion_add)
        self.toolbar.addAction(self.add)

        #---delete---

        self.delete = QAction(QIcon('imagenes/img_10.png'), 'Delete', self)
        self.delete.triggered.connect(self.accion_delete)
        self.toolbar.addAction(self.delete)

        #---insert----
        self.insert = QAction(QIcon('imagenes/img_11.png'), 'Insert', self)
